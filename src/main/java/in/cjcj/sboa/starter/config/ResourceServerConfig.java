...
import in.cjcj.sboa.starter.props.OAuthResourceServerProps;
...
@Configuration
@EnableWebSecurity
@ConditionalOnProperty("oauthresourceserver.enable")
public class ResourceServerConfig extends WebSecurityConfigurerAdapter {
    private final OAuthResourceServerProps resourceServerProps;
    private final String contextPath;

    public ResourceServerConfig(OAuthResourceServerProps resourceServerProps, Environment environment) {
