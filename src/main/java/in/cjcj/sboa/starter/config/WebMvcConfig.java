...
import in.cjcj.sboa.starter.config.filters.CustomServletRequestLoggingFilter;
import in.cjcj.sboa.starter.config.filters.NoOpServletRequestLoggingFilter;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        if (this.developmentProps.getResponse().getEnableGlobalCors()) {
            registry.addMapping("/**");
        }
    }
